...
export default function StorySection() {
  const pills = ['Western Uganda Born', 'Makerere Graduate', 'Software Engineer', 'Coffee Founder'];
        ...
        <div className="grid grid-cols-1 items-center gap-20 lg:grid-cols-2">
          ...
          >
            <blockquote className="mb-8 border-l-2 border-gold pl-8">
              <p className="font-display text-[clamp(20px,3vw,34px)] italic leading-[1.45] text-cream">
                &ldquo;I did not build POVU to sell coffee. I built it to change what a cup of Western Uganda Robusta is worth — to the farmer who grew it and to the world that drinks it.&rdquo;
              </p>
          ...
          >
            ...
            <div className="space-y-5 font-sans text-[14px] font-light leading-[1.8] text-cream/40">
              <p>
                Born in Western Uganda to a mother with a serious mental illness, Emmanuel was raised by his elderly grandmother from three months old. She fed him mashed Irish potatoes mixed with milk. In 2011, his mother passed. He was in Primary Six.
              </p>
              <p>
              ...
              <p>
                He founded COTE TECH (U) Limited. Then he returned to Western Uganda — with digital farmer profiling, professional grading, and above-market pricing — to build what no supply chain had ever offered those farmers: dignity.
              </p>
            </div>
            <div className="mt-8">
              <Link href="/story">
