...
export const singleProducts: Product[] = [
  {
    ...
    description: 'Bold, earthy, dark chocolate body. Western Uganda wild-type at its finest. Delivers the thickest povu crema of any African origin.',
...
export const bundles: Bundle[] = [
  {
    ...
    promise: 'Your first taste of what Western Uganda grows. The story starts here.',
    priceUGX: 60000,
    priceUSD: 17,
    savingUGX: 4000,
  ...
  },
  {
    ...
    name: 'The Western Uganda Signature',
...
export const subscriptions: Subscription[] = [
  ...
  },
  {
    ...
    promise: 'Your roastery powered by a guaranteed Western Uganda supply.',
    priceUGX: 0,
    priceUSD: 0,
    annualUGX: 0,
    isCustom: true,
